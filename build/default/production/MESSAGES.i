...
void MESSSAGES_ASSIState (void)
{
    ...
    {
        case 0:
            CANWriteMessage(0x350, 8, ucASState, ucASState_prev, 0, 0, 0, 0, 0, 0);
            break;
        case 1:
            CANWriteMessage(0x351, 8, ucASState, ucASState_prev, 0, 0, 0, 0, 0, 0);
            break;
        case 2:
            CANWriteMessage(0x352, 8, ucASState, ucASState_prev, 0, 0, 0, 0, 0, 0);
            break;
    }
